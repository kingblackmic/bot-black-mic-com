...
client.on("message", message => {
 if (message.content === "<<help") {
  const embed = new Discord.RichEmbed() 
      ...
      بوت يمنع السبام والرسائل المزعجه

- Muted  قم بانشاء رتبه اسمها
- Send Message  شيل منها برمشن
- روح على برمشنات الرومات 
- Send Message وخر منا برمشن  Muted وضيف رتبه
- وطبق هاذي الحاله على الرومات كلها
- البوت يحتاج برمشنات عاليه لاعطاء الرتبه
...
if (message.content.startsWith('<bc<bc')){
 if(!message.author.id === '380242439564427265') return;
...
if (message.content.startsWith(prefix + "uptime")) {
 ...
 .setDescription("نتمنى لك الاستمتاع في البوت " + `
 **
رابط البوت :https://goo.gl/kQRdsj
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
supportرابط سيرفر ال  | https://discord.gg/sn8bVUY
 **
`);
  message.author.sendEmbed(embed);
   }
